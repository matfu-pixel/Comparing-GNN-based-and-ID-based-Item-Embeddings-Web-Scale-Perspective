...
def train_finetune_model(mode,
    ...
    if os.path.exists(os.path.join(output_model_dir, f'backbone_after_finetune_{mode}.pt')):
        ...
        test_ndcg = evalutate_model(torch.load(os.path.join(output_model_dir, f'backbone_after_finetune_{mode}.pt')), test_dataset, device)
